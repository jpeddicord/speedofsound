 ...
 * 
 * This class is based on the work of Randall Mitchell in his Android Database
 * Tutorial located at the following:
 * 
...
public class DatabaseManager
{
	 ...
	 * 
	 * @param context
	 *            The Activity or Application that is creating an object from
	 *            this class.
	 */
	...
	/**
	 * Calls the constructor if a DBManager does not already exist. Returns the
	 * newly opened or previously opened DBManager.
	 * 
	 * @param context
	 *            The Activity or Application that is creating an object from
	 *            this class.
	 ...
	 * @param color
	 *            The color of the path associated with this song.
	 */
	 ...
	 * 
	 * @param songid
	 *            The id of the song being played at this point
	 * @param latitude
	 *            The latitude in microdegrees (degrees * 1E6)
	 * @param longitude
	 *            The longitude in microdegrees (degrees * 1E6)
	 * 
	 */
	...
	/**
	 * Removes older entries from the database. Used to keep the database from
	 * becoming too large.
	 */
	...
	/**
	 * Find the index of the song provided. Songs should not be added more than
	 * once but if they are this will return the first record. Returns -1 if the
	 * song was not found.
	 * 
	 * @param name
	 *            Name of the song
	...
	/**
	 * Find the name of the song with the given index. If the index does not
	 * exist this will return a song name of "Unknown".
	 * 
	 * @param id
	 *            The id of the song.
	...
	/**
	 * Get the color-int of the path associated with the song id. If no song can
	 * be found then this will return the color-int for Color.WHITE.
	 * 
	 * @param id
	 *            id for the song
	 ...
	 * 
	 * @return An array where the first item is the lowest index and second is
	 *         highest
	 */
